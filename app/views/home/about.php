    ...
    <div class="container">
        <div class="about-content">
            ...
            <div class="image-block">
                <img src="public/assets/images/about/team.jpg" alt="Notre équipe">
            ...
            <div class="team-grid">
                <div class="team-member">
                    <div class="profile-circle">
                        <img src="public/assets/images/about/member1.jpg" alt="Sophie Martin">
                    </div>
                    <h3>Sophie Martin</h3>
                ...
                <div class="team-member">
                    <div class="profile-circle">
                        <img src="public/assets/images/about/member2.jpg" alt="Pierre Dubois">
                    </div>
                    <h3>Pierre Dubois</h3>
                ...
                <div class="team-member">
                    <div class="profile-circle">
                        <img src="public/assets/images/about/member3.jpg" alt="Marie Leroy">
                    </div>
                    <h3>Marie Leroy</h3>
