        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <h2 class="display-4"><?= $userCount ?? 0 ?></h2>
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    ...
                    <h2 class="display-4"><?= $tripCount ?? 0 ?></h2>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    ...
                    <h2 class="display-4"><?= $paymentCount ?? 0 ?></h2>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-dark">
                <div class="card-body">
                    ...
                    <h2 class="display-4"><?= number_format($totalRevenue ?? 0, 0, ',', ' ') ?> €</h2>
