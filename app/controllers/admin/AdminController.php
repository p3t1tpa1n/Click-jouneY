...
class AdminController {
    ...
    public function trips() {
        ...
        // Charger la vue
        include 'app/views/partials/header.php';
        include 'app/views/admin/trips.php';
        include 'app/views/partials/footer.php';
    }
    ...
    public function editTrip($id = null) {
        ...
        // Charger la vue
        include 'app/views/partials/header.php';
        include 'app/views/admin/edit-trip.php';
        include 'app/views/partials/footer.php';
    }
    ...
    public function deleteTrip($id = null) {
        ...
        if (!isset($_GET['confirm']) || $_GET['confirm'] !== 'yes') {
            ...
            include 'app/views/partials/header.php';
            include 'app/views/admin/confirm.php';
            include 'app/views/partials/footer.php';
            return;
        }
    ...
    public function viewUser($login = null) {
        ...
        // Charger la vue
        include 'app/views/partials/header.php';
        include 'app/views/admin/view-user.php';
        include 'app/views/partials/footer.php';
    }
    ...
    public function payments() {
        ...
        // Charger la vue
        include 'app/views/partials/header.php';
        include 'app/views/admin/payments.php';
        include 'app/views/partials/footer.php';
    }
